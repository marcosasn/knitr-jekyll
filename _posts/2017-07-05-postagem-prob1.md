...
{% highlight text %}
## Error: '../dados/series_from_imdb.csv' does not exist in current working directory ('C:/Users/Win7/gitlocal/knitr-jekyll-ad1/_source/postagem-prob1').
{% endhighlight %}
...
{% highlight text %}
## Error in eval(lhs, parent, parent): object 'dados' not found
{% endhighlight %}
# `Sense8`
